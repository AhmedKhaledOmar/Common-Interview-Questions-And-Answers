💼 𝗗𝗲𝗹𝗼𝗶𝘁𝘁𝗲 𝗜𝗻𝘁𝗲𝗿𝘃𝗶𝗲𝘄 𝗤𝘂𝗲𝘀𝘁𝗶𝗼𝗻𝘀 – .𝗡𝗘𝗧 𝗙𝘂𝗹𝗹 𝗦𝘁𝗮𝗰𝗸 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 🚀

🧩 𝗥𝗼𝘂𝗻𝗱 𝟭 – 𝗖𝗼𝗱𝗶𝗻𝗴 (𝗛𝗮𝗰𝗸𝗲𝗿𝗥𝗮𝗻𝗸)

1. Design a custom .NET Core Middleware.

2. Create an MVC API call on table data using HTTP routes with on-click events.

3. Find the missing number in an array.

⚙️ 𝗥𝗼𝘂𝗻𝗱 𝟮 – 𝗔𝗜 𝗧𝗲𝗰𝗵𝗻𝗶𝗰𝗮𝗹 𝗥𝗼𝘂𝗻𝗱

1. Explain your project architecture and key design decisions.

2. Describe your daily work responsibilities and how you manage project deliverables.

3. How do you approach complex technical challenges in your projects?

4. Explain how you deliver end-to-end solutions in your current architecture.

💻 𝗥𝗼𝘂𝗻𝗱 𝟯 – 𝗧𝗲𝗰𝗵𝗻𝗶𝗰𝗮𝗹 𝗗𝗶𝘀𝗰𝘂𝘀𝘀𝗶𝗼𝗻 (𝗟𝟭)

1. Introduction, project roles and responsibilities.

2. What is Middleware?

3. How does .NET Core workflow operate?

4. Difference between Filter and Middleware.

5. What is an Extension Method in C#?

6. Explain HTTP Client in Angular and how it works.

7. Explain Map and Reduce functions in JavaScript.

8. What is an Event call in Microservices?

9. How do you write a structured HTTP POST API with validation?

10. What is your approach to resolve a production-level bug?

11. Common SQL operation questions.

12. Difference between Static and Singleton.

13. Design Patterns – differentiate any two you know.

🏗️ 𝗥𝗼𝘂𝗻𝗱 𝟰 – 𝗧𝗲𝗰𝗵𝗻𝗶𝗰𝗮𝗹 𝗗𝗶𝘀𝗰𝘂𝘀𝘀𝗶𝗼𝗻 (𝗟𝟮)

1. Design a complete system architecture (backend to frontend) using microservices.

2. How would you architect a solution for the Transport & Logistics domain?

3. Which Azure services would you choose for each component and why?

4. How would you ensure the system can handle over 5 million requests simultaneously?

5. How would you maintain performance, scalability, and reliability at such scale?
